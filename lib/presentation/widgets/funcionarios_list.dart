...
class _FuncionariosListState extends State<FuncionariosList> {
  ...
  Future<void> _updateFuncionario(Funcionario funcionario, String novoCodigoCartao) async {
    try {
                              ...
                              onPressed: () {
                                showDialog(
                                  ...
                                  builder: (BuildContext context) {
                                    TextEditingController codigoCartaoController = TextEditingController(text: funcionario.codigo_cartao);
                        
                                    return AlertDialog(
                                      title: const Center(child: Text('Código do Cartão', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14),)),
                                      content: Column(
                                      ...
                                      actions: [
                                        ...
                                        TextButton(
                                          onPressed: () {
                                            _updateFuncionario(funcionario, codigoCartaoController.text);
                                          },
